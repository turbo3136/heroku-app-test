...
list_of_inputs = [
    TurboInput(
        output_id_list=['positive-line', 'pct_of_population_positive-line', 'pct_of_population_positive-choropleth'],
        input_type='Dropdown',
        df=df,
        value_column='state',
...
list_of_outputs = [
    TurboOutput(
        output_component_id='positive-line',
    ...
    TurboOutput(
        output_component_id='pct_of_population_positive-line',
        output_component_property='figure',
        output_type='line',
        df=df,
        x='date',
        y='pct_of_population_positive',
        color='state',
        template='seaborn',
        turbo_input_list=list_of_inputs
    ),
    TurboOutput(
        output_component_id='pct_of_population_positive-choropleth',
        output_component_property='figure',
        output_type='choropleth',
        df=df[df['date'] == df['date'].max()],
        locations='state',
        locationmode='USA-states',
        color='pct_of_population_positive',
        template='seaborn',
        turbo_input_list=list_of_inputs,
    ),
]
...
td = turbo_dash(
    ...
    turbo_header_links_list=[
        ...
        {'href': '/positives', 'text': 'Positives', 'link_class_name': 'header-link-current'},
